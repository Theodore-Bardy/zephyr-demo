...
extern "C"
{
     ...
     * @return true if the connection was initiated successfully, false
     * otherwise
     */
     ...
     * @return true if the disconnection was initiated successfully, false
     * otherwise
     */
     ...
     * @param mac_address Pointer to a buffer where the MAC address will be
     * stored
     */
